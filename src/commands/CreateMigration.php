...
use GFL\Elearning\Support\config\GenerateConfigReader;
use GFL\Elearning\support\migrations\NameParser;
use GFL\Elearning\support\migrations\SchemaParser;
...
class CreateMigration extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $name = 'gfl:make-migration';
    /**
    ...
    {
        return dirname(__FILE__, 2) . '/migrations/' . $this->getFileName() . '.php';
    }
    /**
     * @return string
     */
